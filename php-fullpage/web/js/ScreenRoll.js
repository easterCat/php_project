...
(function($) {
	...
	var _prefix = (function(temp) {
		...
		return false;
	})(document.createElement(ScreenRoll));

	//设置一个闭包对象
	var ScreenRoll = (function() {
		function ScreenRoll(element, options) {
			this.settings = $.extend(true, $.fn.ScreenRoll.defaults, options || {});
			this.element = element;
			this.init();
		}

		ScreenRoll.prototype = {
			/*说明：初始化插件*/
			...
			_initPaging: function() {
				...
				for(var i = 0; i < me.pagesCount; i++) {
					pageHtml += "<li class='pages-li'></li>";
				}
				me.element.append(pageHtml);
				var pages = me.element.find(me.selectors.page);
				me.pageItem = pages.find(".pages-li");
	...
	$.fn.ScreenRoll = function(options) {
		return this.each(function() {
			var me = $(this),
				instance = me.data("ScreenRoll");
			if(!instance) {
				me.data("ScreenRoll", (instance = new ScreenRoll(me, options)));
			}
