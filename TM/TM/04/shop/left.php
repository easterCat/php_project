...
<table width="209" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td height="153" background="images/dl.gif">
            <table width="209" border="0" cellspacing="0" cellpadding="0">
                <tr>
                            ...
                            <tr>
                                <td valign="top">
                                    <table width="100%" height="100" border="0" align="center" cellpadding="0"
                                        ...
                                        <tr>
                                            <td>
                                                <table width="180" height="100" border="0" align="center"
                                                            ...
                                                            <table width="180" border="0" cellpadding="0"
                                                                ...
                                                                <script language="javascript">
                                                                    function openfindpwd() {
                                                                        window.open("openfindpwd.php", "newframe", "left=200,top=200,width=600,height=300,menubar=no,toolbar=no,location=no,scrollbars=no,location=no");
                                                                    }
                                                                </script>
                                                                        ...
                                                                        <td height="20" colspan="3">
                                                                            <div align="right">
                                                                                ...
                                                                                <input name="submit" type="submit"
                                                                                       class="buttoncss" value="登录">
                                                                                <a href="agreereg.php">注册账号</a>&nbsp;<a
                                                                                        href="javascript:openfindpwd()">忘记密码</a>&nbsp;
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </form>
    ...
    <tr>
        <td height="40" background="images/line3.gif">
                    ...
                    <td>
                        <table width="180" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            if ($info == false) {
                                ?>
                                <tr>
                                    <td height="20" align="center">并无公告</td>
                                </tr>
                                <?php
                            } else {
                                do {
                                                ...
                                                <table width="180" border="0" align="center" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td width="16" height="5">
                                                            <div align="center"><img src="images/xing.gif" width="9"
                                                                                     height="9"></div>
                                                        </td>
                                                        <td width="164" height="24">
                                                            <div align="left"><a
                                                                        href="showgg.php?id=<?php echo $info["id"]; ?>">
                                                                    <?php
                ...
                <tr>
                    <td>
                        <table width="180" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <?php
                            $sql = mysqli_query($conn, "select * from tb_links order by linkid desc limit 0,5");
                            $info = mysqli_fetch_array($sql);
                            if ($info == false) {
                                ?>
                                <tr>
                                    <td height="20" align="center">没有链接!</td>
                                </tr>
                                <?php
                            } else {
                                do {
                                                ...
                                                <table width="180" border="0" align="center" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td width="20" height="5">
                                                            <div align="center"><img src="images/circle.gif" width="10"
                                                                                     height="10"></div>
                                                        </td>
                                                        <td width="160" height="24">
                                                            <div align="left"><a href="<?php echo $info["linkurl"]; ?>"
                                                                                 target="_blank">
                                                                    <?php
...
<p>&nbsp;</p>
<map name="Map">
    <area shape="rect" coords="159,15,195,29" href="showgonggao.php?page=">
</map>
