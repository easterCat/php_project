        ...
        <tr>
            ...
            <td width="557" align="center" valign="top" bgcolor="#FFFFFF">
                ...
                <table width="550" height="70" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    $sql = mysqli_query($conn, "select * from tb_shangpin order by addtime desc limit $select_from,$select_to");
                        ...
                        do {
                            ...
                            <tr>
                                ...
                                <td width="93" height="20">
                                    <div align="center" style="color: #000000">商品</div>
                                </td>
                                <td colspan="2">
                                    <div align="left"><a
                            ...
                            <tr>
                                ...
                                <td width="73">
                                    <div align="left"><?php echo $info["tupian"]; ?></div>
                                </td>
                            </tr>
                            <tr>
                                <td height="20">
                    ...
                    <tr>
                        ...
                        $newPage = new Page($page_count, 5, $page_now, 'shownew.php?page=', 2);
