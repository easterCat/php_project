...
<table width="200" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr bgcolor="#FFFFFF">
        <td width="76" height="25">
            <div align="center">�ǳƣ�</div>
        </td>
        <td width="124">
            <div align="left"><?php echo $nc; ?></div>
        </td>
    </tr>
    <tr bgcolor="#FFFFFF">
        <td height="25">
        ...
        <td height="25">
            <div align="left"><?php echo $info[pwd1]; ?></div>
        </td>
    </tr>
    <tr bgcolor="#FFFFFF">
        <td height="25" colspan="2">
            <div align="center"><input name="submit" type="button" id="submit" onClick="window.close()" value="ȷ��">
            </div>
        </td>
    </tr>
</table>
