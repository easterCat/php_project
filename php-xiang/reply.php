...
<body>
    <form method="post" action="php/reply_post.php?id=<?php echo $_GET['id']; ?>" onsubmit=" return checkinput();" name="myform">
        <table width="500px" border="1" cellpadding="8" cellspacing="0" align="center">
            <tr class="title">
                <td colspan="2">回复帖子<span class="right">[
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="reply_author">
                </td>
            </tr>
            <tr>
                <tr>
